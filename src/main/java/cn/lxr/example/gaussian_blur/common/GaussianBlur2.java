...
public class GaussianBlur2 {
    ...
    private GaussianBlur2() {
    }

    private static GaussianBlur2 blur;

    public static GaussianBlur2 getInstance() {
        if (blur == null) {
            blur = new GaussianBlur2();
        }
        return blur;
    }
    ...
    public void printWeightedMatrixToFile(double[][] weightMatrix, String path) {
